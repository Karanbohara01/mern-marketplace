...
const Post = ({ post }) => {
  ...
  return (
    <div className="rounded-md hover:border  shadow-lg text-black w-full max-w-sm mx-auto bg-white p-4">
      {/* Image Section */}
      <img
        onClick={() => {
        ...
        className="rounded-lg cursor-pointer w-full h-48 object-cover mb-4"
        src={post.image}
